...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24442fe0 	addiu	a0,v0,12256
  ...
  800078:	24442ffc 	addiu	a0,v0,12284
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24443000 	addiu	a0,v0,12288
  ...
  8000e8:	24442ffc 	addiu	a0,v0,12284
...
exit(int error_code) {
  ...
  800774:	24443020 	addiu	a0,v0,12320
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24443040 	addiu	a0,v0,12352
  ...
  800d70:	2464304c 	addiu	a0,v1,12364
  ...
  800d8c:	24643060 	addiu	a0,v1,12384
  ...
  800da8:	24643074 	addiu	a0,v1,12404
  ...
  800dc4:	24643088 	addiu	a0,v1,12424
...
void _PrintInt(int x) {
  ...
  8010f0:	244430a0 	addiu	a0,v0,12448
...
void _PrintChar(char x) {
  ...
  801138:	246430a4 	addiu	a0,v1,12452
...
void _PrintString(const char* x) {
  ...
  801178:	244430a8 	addiu	a0,v0,12456
...
void _PrintBool(bool x) {
  ...
  8011c4:	244430ac 	addiu	a0,v0,12460
  ...
  8011dc:	244430b4 	addiu	a0,v0,12468
...
umain(int argc, char *argv[]) {
  ...
  801490:	244530c0 	addiu	a1,v0,12480
  ...
  8014b4:	244430c8 	addiu	a0,v0,12488
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	244630dc 	addiu	a2,v0,12508
  ...
  8014d8:	244530f8 	addiu	a1,v0,12536
  ...
  8014fc:	244430c8 	addiu	a0,v0,12488
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463100 	addiu	a2,v0,12544
  ...
  801520:	0c200bc0 	jal	802f00 <main>
  801524:	00000000 	nop
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433330 	addiu	v1,v0,13104
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442335c 	addiu	v0,v0,13148
  ...
  80275c:	244232cc 	addiu	v0,v0,13004
  ...
  802784:	24473344 	addiu	a3,v0,13124
  ...
  8027ac:	24473350 	addiu	a3,v0,13136
  ...
  8027dc:	24513354 	addiu	s1,v0,13140
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  802e90:	afc40028 	sw	a0,40(s8)
    int i, time = 100;
  802e94:	24020064 	li	v0,100
  802e98:	afc2001c 	sw	v0,28(s8)
    for (i = 0; i < 10; i ++) {
  802e9c:	afc00018 	sw	zero,24(s8)
  802ea0:	08200bb9 	j	802ee4 <sleepy+0x64>
  802ea4:	00000000 	nop
        sleep(time);
  802ea8:	8fc2001c 	lw	v0,28(s8)
  802eac:	00402021 	move	a0,v0
  802eb0:	0c20024c 	jal	800930 <sleep>
  802eb4:	00000000 	nop
        cprintf("sleep %d x %d slices.\n", i + 1, time);
  802eb8:	8fc20018 	lw	v0,24(s8)
  802ebc:	24420001 	addiu	v0,v0,1
  802ec0:	3c030080 	lui	v1,0x80
  802ec4:	246434c0 	addiu	a0,v1,13504
  802ec8:	00402821 	move	a1,v0
  802ecc:	8fc6001c 	lw	a2,28(s8)
  802ed0:	0c2003a9 	jal	800ea4 <cprintf>
  802ed4:	00000000 	nop
#include <ulib.h>
...
sleepy(int pid) {
  ...
  802edc:	24420001 	addiu	v0,v0,1
  802ee0:	afc20018 	sw	v0,24(s8)
  802ee4:	8fc20018 	lw	v0,24(s8)
  802ee8:	2842000a 	slti	v0,v0,10
  802eec:	1440ffee 	bnez	v0,802ea8 <sleepy+0x28>
  802ef0:	00000000 	nop
        sleep(time);
        cprintf("sleep %d x %d slices.\n", i + 1, time);
    }
    exit(0);
  802ef4:	00002021 	move	a0,zero
  802ef8:	0c2001d4 	jal	800750 <exit>
  802efc:	00000000 	nop
...
int
main(void) {
  802f00:	27bdffd0 	addiu	sp,sp,-48
  802f04:	afbf002c 	sw	ra,44(sp)
  802f08:	afbe0028 	sw	s8,40(sp)
  802f0c:	03a0f021 	move	s8,sp
    unsigned int time = gettime_msec();
  802f10:	0c20025a 	jal	800968 <gettime_msec>
  802f14:	00000000 	nop
  802f18:	afc20018 	sw	v0,24(s8)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  802f1c:	0c2001e2 	jal	800788 <fork>
  802f20:	00000000 	nop
  802f24:	afc2001c 	sw	v0,28(s8)
  802f28:	8fc2001c 	lw	v0,28(s8)
  802f2c:	14400004 	bnez	v0,802f40 <main+0x40>
  802f30:	00000000 	nop
        sleepy(pid1);
  802f34:	8fc4001c 	lw	a0,28(s8)
  802f38:	0c200ba0 	jal	802e80 <sleepy>
  802f3c:	00000000 	nop
    }
    
    assert(waitpid(pid1, &exit_code) == 0 && exit_code == 0);
  802f40:	27c20020 	addiu	v0,s8,32
  802f44:	8fc4001c 	lw	a0,28(s8)
  802f48:	00402821 	move	a1,v0
  802f4c:	0c2001fc 	jal	8007f0 <waitpid>
  802f50:	00000000 	nop
  802f54:	14400004 	bnez	v0,802f68 <main+0x68>
  802f58:	00000000 	nop
  802f5c:	8fc20020 	lw	v0,32(s8)
  802f60:	1040000a 	beqz	v0,802f8c <main+0x8c>
  802f64:	00000000 	nop
  802f68:	3c020080 	lui	v0,0x80
  802f6c:	244434d8 	addiu	a0,v0,13528
  802f70:	24050017 	li	a1,23
  802f74:	3c020080 	lui	v0,0x80
  802f78:	244634e8 	addiu	a2,v0,13544
  802f7c:	3c020080 	lui	v0,0x80
  802f80:	24473500 	addiu	a3,v0,13568
  802f84:	0c200008 	jal	800020 <__panic>
  802f88:	00000000 	nop
    cprintf("use %04d msecs.\n", gettime_msec() - time);
  802f8c:	0c20025a 	jal	800968 <gettime_msec>
  802f90:	00000000 	nop
  802f94:	00401821 	move	v1,v0
  802f98:	8fc20018 	lw	v0,24(s8)
  802f9c:	00621023 	subu	v0,v1,v0
  802fa0:	3c030080 	lui	v1,0x80
  802fa4:	24643534 	addiu	a0,v1,13620
  802fa8:	00402821 	move	a1,v0
  802fac:	0c2003a9 	jal	800ea4 <cprintf>
  802fb0:	00000000 	nop
    cprintf("sleep pass.\n");
  802fb4:	3c020080 	lui	v0,0x80
  802fb8:	24443548 	addiu	a0,v0,13640
  802fbc:	0c2003a9 	jal	800ea4 <cprintf>
  802fc0:	00000000 	nop
    return 0;
  802fc4:	00001021 	move	v0,zero
}
  802fc8:	03c0e821 	move	sp,s8
  802fcc:	8fbf002c 	lw	ra,44(sp)
  802fd0:	8fbe0028 	lw	s8,40(sp)
  802fd4:	27bd0030 	addiu	sp,sp,48
  802fd8:	03e00008 	jr	ra
  802fdc:	00000000 	nop
