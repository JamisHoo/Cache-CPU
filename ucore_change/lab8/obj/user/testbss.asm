...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24443020 	addiu	a0,v0,12320
  ...
  800078:	2444303c 	addiu	a0,v0,12348
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24443040 	addiu	a0,v0,12352
  ...
  8000e8:	2444303c 	addiu	a0,v0,12348
...
exit(int error_code) {
  ...
  800774:	24443060 	addiu	a0,v0,12384
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24443080 	addiu	a0,v0,12416
  ...
  800d70:	2464308c 	addiu	a0,v1,12428
  ...
  800d8c:	246430a0 	addiu	a0,v1,12448
  ...
  800da8:	246430b4 	addiu	a0,v1,12468
  ...
  800dc4:	246430c8 	addiu	a0,v1,12488
...
void _PrintInt(int x) {
  ...
  8010f0:	244430e0 	addiu	a0,v0,12512
...
void _PrintChar(char x) {
  ...
  801138:	246430e4 	addiu	a0,v1,12516
...
void _PrintString(const char* x) {
  ...
  801178:	244430e8 	addiu	a0,v0,12520
...
void _PrintBool(bool x) {
  ...
  8011c4:	244430ec 	addiu	a0,v0,12524
  ...
  8011dc:	244430f4 	addiu	a0,v0,12532
...
umain(int argc, char *argv[]) {
  ...
  801490:	24453100 	addiu	a1,v0,12544
  ...
  8014b4:	24443108 	addiu	a0,v0,12552
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	2446311c 	addiu	a2,v0,12572
  ...
  8014d8:	24453138 	addiu	a1,v0,12600
  ...
  8014fc:	24443108 	addiu	a0,v0,12552
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463140 	addiu	a2,v0,12608
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433370 	addiu	v1,v0,13168
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442339c 	addiu	v0,v0,13212
  ...
  80275c:	2442330c 	addiu	v0,v0,13068
  ...
  802784:	24473384 	addiu	a3,v0,13188
  ...
  8027ac:	24473390 	addiu	a3,v0,13200
  ...
  8027dc:	24513394 	addiu	s1,v0,13204
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  802e94:	24443500 	addiu	a0,v0,13568
  802e98:	0c2003a9 	jal	800ea4 <cprintf>
  802e9c:	00000000 	nop
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  802ea0:	afc00018 	sw	zero,24(s8)
  802ea4:	08200bbe 	j	802ef8 <main+0x78>
  802ea8:	00000000 	nop
        if (bigarray[i] != 0) {
  802eac:	3c020080 	lui	v0,0x80
  802eb0:	8fc30018 	lw	v1,24(s8)
  802eb4:	00031880 	sll	v1,v1,0x2
  802eb8:	24424128 	addiu	v0,v0,16680
  802ebc:	00621021 	addu	v0,v1,v0
  802ec0:	8c420000 	lw	v0,0(v0)
  802ec4:	10400009 	beqz	v0,802eec <main+0x6c>
  802ec8:	00000000 	nop
            panic("bigarray[%d] isn't cleared!\n", i);
  802ecc:	3c020080 	lui	v0,0x80
  802ed0:	24443520 	addiu	a0,v0,13600
  802ed4:	2405000e 	li	a1,14
  802ed8:	3c020080 	lui	v0,0x80
  802edc:	24463530 	addiu	a2,v0,13616
  802ee0:	8fc70018 	lw	a3,24(s8)
  802ee4:	0c200008 	jal	800020 <__panic>
  802ee8:	00000000 	nop
...
main(void) {
  ...
  802ef0:	24420001 	addiu	v0,v0,1
  802ef4:	afc20018 	sw	v0,24(s8)
  802ef8:	8fc30018 	lw	v1,24(s8)
  802efc:	3c020010 	lui	v0,0x10
  802f00:	0062102a 	slt	v0,v1,v0
  802f04:	1440ffe9 	bnez	v0,802eac <main+0x2c>
  802f08:	00000000 	nop
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  802f0c:	afc00018 	sw	zero,24(s8)
  802f10:	08200bd0 	j	802f40 <main+0xc0>
  802f14:	00000000 	nop
        bigarray[i] = i;
  802f18:	8fc30018 	lw	v1,24(s8)
  802f1c:	3c020080 	lui	v0,0x80
  802f20:	8fc40018 	lw	a0,24(s8)
  802f24:	00042080 	sll	a0,a0,0x2
  802f28:	24424128 	addiu	v0,v0,16680
  802f2c:	00821021 	addu	v0,a0,v0
  802f30:	ac430000 	sw	v1,0(v0)
    for (i = 0; i < ARRAYSIZE; i ++) {
        if (bigarray[i] != 0) {
            panic("bigarray[%d] isn't cleared!\n", i);
        }
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  802f34:	8fc20018 	lw	v0,24(s8)
  802f38:	24420001 	addiu	v0,v0,1
  802f3c:	afc20018 	sw	v0,24(s8)
  802f40:	8fc30018 	lw	v1,24(s8)
  802f44:	3c020010 	lui	v0,0x10
  802f48:	0062102a 	slt	v0,v1,v0
  802f4c:	1440fff2 	bnez	v0,802f18 <main+0x98>
  802f50:	00000000 	nop
        bigarray[i] = i;
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  802f54:	afc00018 	sw	zero,24(s8)
  802f58:	08200bec 	j	802fb0 <main+0x130>
  802f5c:	00000000 	nop
        if (bigarray[i] != i) {
  802f60:	3c020080 	lui	v0,0x80
  802f64:	8fc30018 	lw	v1,24(s8)
  802f68:	00031880 	sll	v1,v1,0x2
  802f6c:	24424128 	addiu	v0,v0,16680
  802f70:	00621021 	addu	v0,v1,v0
  802f74:	8c430000 	lw	v1,0(v0)
  802f78:	8fc20018 	lw	v0,24(s8)
  802f7c:	10620009 	beq	v1,v0,802fa4 <main+0x124>
  802f80:	00000000 	nop
            panic("bigarray[%d] didn't hold its value!\n", i);
  802f84:	3c020080 	lui	v0,0x80
  802f88:	24443520 	addiu	a0,v0,13600
  802f8c:	24050016 	li	a1,22
  802f90:	3c020080 	lui	v0,0x80
  802f94:	24463550 	addiu	a2,v0,13648
  802f98:	8fc70018 	lw	a3,24(s8)
  802f9c:	0c200008 	jal	800020 <__panic>
  802fa0:	00000000 	nop
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
    ...
    for (i = 0; i < ARRAYSIZE; i ++) {
  802fa4:	8fc20018 	lw	v0,24(s8)
  802fa8:	24420001 	addiu	v0,v0,1
  802fac:	afc20018 	sw	v0,24(s8)
  802fb0:	8fc30018 	lw	v1,24(s8)
  802fb4:	3c020010 	lui	v0,0x10
  802fb8:	0062102a 	slt	v0,v1,v0
  802fbc:	1440ffe8 	bnez	v0,802f60 <main+0xe0>
  802fc0:	00000000 	nop
        if (bigarray[i] != i) {
            panic("bigarray[%d] didn't hold its value!\n", i);
        }
  ...
  802fc4:	3c020080 	lui	v0,0x80
  802fc8:	24443578 	addiu	a0,v0,13688
  802fcc:	0c2003a9 	jal	800ea4 <cprintf>
  802fd0:	00000000 	nop
    cprintf("testbss may pass.\n");
  802fd4:	3c020080 	lui	v0,0x80
  802fd8:	244435ac 	addiu	a0,v0,13740
  802fdc:	0c2003a9 	jal	800ea4 <cprintf>
  802fe0:	00000000 	nop

    bigarray[ARRAYSIZE + 1024] = 0;
  802fe4:	3c020080 	lui	v0,0x80
  802fe8:	24424128 	addiu	v0,v0,16680
  802fec:	3c030040 	lui	v1,0x40
  802ff0:	00621021 	addu	v0,v1,v0
  802ff4:	ac401000 	sw	zero,4096(v0)
    panic("FAIL: T.T\n");
  802ff8:	3c020080 	lui	v0,0x80
  802ffc:	24443520 	addiu	a0,v0,13600
  803000:	2405001e 	li	a1,30
  803004:	3c020080 	lui	v0,0x80
  803008:	244635c0 	addiu	a2,v0,13760
  80300c:	0c200008 	jal	800020 <__panic>
  803010:	00000000 	nop
	...
