...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24443000 	addiu	a0,v0,12288
  ...
  800078:	2444301c 	addiu	a0,v0,12316
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24443020 	addiu	a0,v0,12320
  ...
  8000e8:	2444301c 	addiu	a0,v0,12316
...
exit(int error_code) {
  ...
  800774:	24443040 	addiu	a0,v0,12352
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24443060 	addiu	a0,v0,12384
  ...
  800d70:	2464306c 	addiu	a0,v1,12396
  ...
  800d8c:	24643080 	addiu	a0,v1,12416
  ...
  800da8:	24643094 	addiu	a0,v1,12436
  ...
  800dc4:	246430a8 	addiu	a0,v1,12456
...
void _PrintInt(int x) {
  ...
  8010f0:	244430c0 	addiu	a0,v0,12480
...
void _PrintChar(char x) {
  ...
  801138:	246430c4 	addiu	a0,v1,12484
...
void _PrintString(const char* x) {
  ...
  801178:	244430c8 	addiu	a0,v0,12488
...
void _PrintBool(bool x) {
  ...
  8011c4:	244430cc 	addiu	a0,v0,12492
  ...
  8011dc:	244430d4 	addiu	a0,v0,12500
...
umain(int argc, char *argv[]) {
  ...
  801490:	244530e0 	addiu	a1,v0,12512
  ...
  8014b4:	244430e8 	addiu	a0,v0,12520
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	244630fc 	addiu	a2,v0,12540
  ...
  8014d8:	24453118 	addiu	a1,v0,12568
  ...
  8014fc:	244430e8 	addiu	a0,v0,12520
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463120 	addiu	a2,v0,12576
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433350 	addiu	v1,v0,13136
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442337c 	addiu	v0,v0,13180
  ...
  80275c:	244232ec 	addiu	v0,v0,13036
  ...
  802784:	24473364 	addiu	a3,v0,13156
  ...
  8027ac:	24473370 	addiu	a3,v0,13168
  ...
  8027dc:	24513374 	addiu	s1,v0,13172
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  802e90:	afc00018 	sw	zero,24(s8)
  802e94:	08200bc4 	j	802f10 <main+0x90>
  802e98:	00000000 	nop
        if ((pid = fork()) == 0) {
  802e9c:	0c2001e2 	jal	800788 <fork>
  802ea0:	00000000 	nop
  802ea4:	afc2001c 	sw	v0,28(s8)
  802ea8:	8fc2001c 	lw	v0,28(s8)
  802eac:	14400009 	bnez	v0,802ed4 <main+0x54>
  802eb0:	00000000 	nop
            cprintf("I am child %d\n", n);
  802eb4:	3c020080 	lui	v0,0x80
  802eb8:	244434e4 	addiu	a0,v0,13540
  802ebc:	8fc50018 	lw	a1,24(s8)
  802ec0:	0c2003a9 	jal	800ea4 <cprintf>
  802ec4:	00000000 	nop
            exit(0);
  802ec8:	00002021 	move	a0,zero
  802ecc:	0c2001d4 	jal	800750 <exit>
  802ed0:	00000000 	nop
        }
        assert(pid > 0);
  802ed4:	8fc2001c 	lw	v0,28(s8)
  802ed8:	1c40000a 	bgtz	v0,802f04 <main+0x84>
  802edc:	00000000 	nop
  802ee0:	3c020080 	lui	v0,0x80
  802ee4:	244434f4 	addiu	a0,v0,13556
  802ee8:	2405000e 	li	a1,14
  802eec:	3c020080 	lui	v0,0x80
  802ef0:	24463504 	addiu	a2,v0,13572
  802ef4:	3c020080 	lui	v0,0x80
  802ef8:	2447351c 	addiu	a3,v0,13596
  802efc:	0c200008 	jal	800020 <__panic>
  802f00:	00000000 	nop
const int max_child = 32;
...
main(void) {
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  802f04:	8fc20018 	lw	v0,24(s8)
  802f08:	24420001 	addiu	v0,v0,1
  802f0c:	afc20018 	sw	v0,24(s8)
  802f10:	24020020 	li	v0,32
  802f14:	8fc30018 	lw	v1,24(s8)
  802f18:	0062102a 	slt	v0,v1,v0
  802f1c:	1440ffdf 	bnez	v0,802e9c <main+0x1c>
  802f20:	00000000 	nop
            exit(0);
        }
        assert(pid > 0);
    ...
    if (n > max_child) {
  802f24:	24020020 	li	v0,32
  802f28:	8fc30018 	lw	v1,24(s8)
  802f2c:	0043102a 	slt	v0,v0,v1
  802f30:	10400009 	beqz	v0,802f58 <main+0xd8>
  802f34:	00000000 	nop
        panic("fork claimed to work %d times!\n", n);
  802f38:	3c020080 	lui	v0,0x80
  802f3c:	244434f4 	addiu	a0,v0,13556
  802f40:	24050012 	li	a1,18
  802f44:	3c020080 	lui	v0,0x80
  802f48:	24463524 	addiu	a2,v0,13604
  802f4c:	8fc70018 	lw	a3,24(s8)
  802f50:	0c200008 	jal	800020 <__panic>
  802f54:	00000000 	nop
    }

    for (; n > 0; n --) {
  802f58:	08200be6 	j	802f98 <main+0x118>
  802f5c:	00000000 	nop
        if (wait() != 0) {
  802f60:	0c2001ee 	jal	8007b8 <wait>
  802f64:	00000000 	nop
  802f68:	10400008 	beqz	v0,802f8c <main+0x10c>
  802f6c:	00000000 	nop
            panic("wait stopped early\n");
  802f70:	3c020080 	lui	v0,0x80
  802f74:	244434f4 	addiu	a0,v0,13556
  802f78:	24050017 	li	a1,23
  802f7c:	3c020080 	lui	v0,0x80
  802f80:	24463544 	addiu	a2,v0,13636
  802f84:	0c200008 	jal	800020 <__panic>
  802f88:	00000000 	nop
    ...
    for (; n > 0; n --) {
  802f8c:	8fc20018 	lw	v0,24(s8)
  802f90:	2442ffff 	addiu	v0,v0,-1
  802f94:	afc20018 	sw	v0,24(s8)
  802f98:	8fc20018 	lw	v0,24(s8)
  802f9c:	1c40fff0 	bgtz	v0,802f60 <main+0xe0>
  802fa0:	00000000 	nop
        if (wait() != 0) {
            panic("wait stopped early\n");
        }
    ...
    if (wait() == 0) {
  802fa4:	0c2001ee 	jal	8007b8 <wait>
  802fa8:	00000000 	nop
  802fac:	14400008 	bnez	v0,802fd0 <main+0x150>
  802fb0:	00000000 	nop
        panic("wait got too many\n");
  802fb4:	3c020080 	lui	v0,0x80
  802fb8:	244434f4 	addiu	a0,v0,13556
  802fbc:	2405001c 	li	a1,28
  802fc0:	3c020080 	lui	v0,0x80
  802fc4:	24463558 	addiu	a2,v0,13656
  802fc8:	0c200008 	jal	800020 <__panic>
  802fcc:	00000000 	nop
    }

    cprintf("forktest pass.\n");
  802fd0:	3c020080 	lui	v0,0x80
  802fd4:	2444356c 	addiu	a0,v0,13676
  802fd8:	0c2003a9 	jal	800ea4 <cprintf>
  802fdc:	00000000 	nop
    return 0;
  802fe0:	00001021 	move	v0,zero
}
  802fe4:	03c0e821 	move	sp,s8
  802fe8:	8fbf0024 	lw	ra,36(sp)
  802fec:	8fbe0020 	lw	s8,32(sp)
  802ff0:	27bd0028 	addiu	sp,sp,40
  802ff4:	03e00008 	jr	ra
  802ff8:	00000000 	nop
  802ffc:	00000000 	nop
