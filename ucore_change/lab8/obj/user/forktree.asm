...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24442ff0 	addiu	a0,v0,12272
  ...
  800078:	2444300c 	addiu	a0,v0,12300
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24443010 	addiu	a0,v0,12304
  ...
  8000e8:	2444300c 	addiu	a0,v0,12300
...
exit(int error_code) {
  ...
  800774:	24443030 	addiu	a0,v0,12336
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24443050 	addiu	a0,v0,12368
  ...
  800d70:	2464305c 	addiu	a0,v1,12380
  ...
  800d8c:	24643070 	addiu	a0,v1,12400
  ...
  800da8:	24643084 	addiu	a0,v1,12420
  ...
  800dc4:	24643098 	addiu	a0,v1,12440
...
void _PrintInt(int x) {
  ...
  8010f0:	244430b0 	addiu	a0,v0,12464
...
void _PrintChar(char x) {
  ...
  801138:	246430b4 	addiu	a0,v1,12468
...
void _PrintString(const char* x) {
  ...
  801178:	244430b8 	addiu	a0,v0,12472
...
void _PrintBool(bool x) {
  ...
  8011c4:	244430bc 	addiu	a0,v0,12476
  ...
  8011dc:	244430c4 	addiu	a0,v0,12484
...
umain(int argc, char *argv[]) {
  ...
  801490:	244530d0 	addiu	a1,v0,12496
  ...
  8014b4:	244430d8 	addiu	a0,v0,12504
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	244630ec 	addiu	a2,v0,12524
  ...
  8014d8:	24453108 	addiu	a1,v0,12552
  ...
  8014fc:	244430d8 	addiu	a0,v0,12504
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463110 	addiu	a2,v0,12560
  ...
  801520:	0c200be5 	jal	802f94 <main>
  801524:	00000000 	nop
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433340 	addiu	v1,v0,13120
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442336c 	addiu	v0,v0,13164
  ...
  80275c:	244232dc 	addiu	v0,v0,13020
  ...
  802784:	24473354 	addiu	a3,v0,13140
  ...
  8027ac:	24473360 	addiu	a3,v0,13152
  ...
  8027dc:	24513364 	addiu	s1,v0,13156
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  802e94:	00a01021 	move	v0,a1
  802e98:	a3c20034 	sb	v0,52(s8)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  802e9c:	8fc40030 	lw	a0,48(s8)
  802ea0:	0c200550 	jal	801540 <strlen>
  802ea4:	00000000 	nop
  802ea8:	2c420004 	sltiu	v0,v0,4
  802eac:	10400018 	beqz	v0,802f10 <forkchild+0x90>
  802eb0:	00000000 	nop
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  802eb4:	83c20034 	lb	v0,52(s8)
  802eb8:	afa20010 	sw	v0,16(sp)
  802ebc:	27c20020 	addiu	v0,s8,32
  802ec0:	00402021 	move	a0,v0
  802ec4:	24050005 	li	a1,5
  802ec8:	3c020080 	lui	v0,0x80
  802ecc:	244634d0 	addiu	a2,v0,13520
  802ed0:	8fc70030 	lw	a3,48(s8)
  802ed4:	0c200b13 	jal	802c4c <snprintf>
  802ed8:	00000000 	nop
    if (fork() == 0) {
  802edc:	0c2001e2 	jal	800788 <fork>
  802ee0:	00000000 	nop
  802ee4:	1440000a 	bnez	v0,802f10 <forkchild+0x90>
  802ee8:	00000000 	nop
        forktree(nxt);
  802eec:	27c20020 	addiu	v0,s8,32
  802ef0:	00402021 	move	a0,v0
  802ef4:	0c200bca 	jal	802f28 <forktree>
  802ef8:	00000000 	nop
        yield();
  802efc:	0c20020c 	jal	800830 <yield>
  802f00:	00000000 	nop
        exit(0);
  802f04:	00002021 	move	a0,zero
  802f08:	0c2001d4 	jal	800750 <exit>
  802f0c:	00000000 	nop
    }
}
  802f10:	03c0e821 	move	sp,s8
  802f14:	8fbf002c 	lw	ra,44(sp)
  802f18:	8fbe0028 	lw	s8,40(sp)
  802f1c:	27bd0030 	addiu	sp,sp,48
  802f20:	03e00008 	jr	ra
  802f24:	00000000 	nop
...
forktree(const char *cur) {
  802f28:	27bdffe0 	addiu	sp,sp,-32
  802f2c:	afbf001c 	sw	ra,28(sp)
  802f30:	afbe0018 	sw	s8,24(sp)
  802f34:	03a0f021 	move	s8,sp
  802f38:	afc40020 	sw	a0,32(s8)
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  802f3c:	0c200226 	jal	800898 <getpid>
  802f40:	00000000 	nop
  802f44:	3c030080 	lui	v1,0x80
  802f48:	246434d8 	addiu	a0,v1,13528
  802f4c:	00402821 	move	a1,v0
  802f50:	8fc60020 	lw	a2,32(s8)
  802f54:	0c2003a9 	jal	800ea4 <cprintf>
  802f58:	00000000 	nop

    forkchild(cur, '0');
  802f5c:	8fc40020 	lw	a0,32(s8)
  802f60:	24050030 	li	a1,48
  802f64:	0c200ba0 	jal	802e80 <forkchild>
  802f68:	00000000 	nop
    forkchild(cur, '1');
  802f6c:	8fc40020 	lw	a0,32(s8)
  802f70:	24050031 	li	a1,49
  802f74:	0c200ba0 	jal	802e80 <forkchild>
  802f78:	00000000 	nop
}
  802f7c:	03c0e821 	move	sp,s8
  802f80:	8fbf001c 	lw	ra,28(sp)
  802f84:	8fbe0018 	lw	s8,24(sp)
  802f88:	27bd0020 	addiu	sp,sp,32
  802f8c:	03e00008 	jr	ra
  802f90:	00000000 	nop
...
int
main(void) {
  802f94:	27bdffe0 	addiu	sp,sp,-32
  802f98:	afbf001c 	sw	ra,28(sp)
  802f9c:	afbe0018 	sw	s8,24(sp)
  802fa0:	03a0f021 	move	s8,sp
    cprintf("forktree process will sleep %d ticks\n",SLEEP_TIME);
  802fa4:	3c020080 	lui	v0,0x80
  802fa8:	244434ec 	addiu	a0,v0,13548
  802fac:	24050190 	li	a1,400
  802fb0:	0c2003a9 	jal	800ea4 <cprintf>
  802fb4:	00000000 	nop
    sleep(SLEEP_TIME);
  802fb8:	24040190 	li	a0,400
  802fbc:	0c20024c 	jal	800930 <sleep>
  802fc0:	00000000 	nop
    forktree("");
  802fc4:	3c020080 	lui	v0,0x80
  802fc8:	24443514 	addiu	a0,v0,13588
  802fcc:	0c200bca 	jal	802f28 <forktree>
  802fd0:	00000000 	nop
    return 0;
  802fd4:	00001021 	move	v0,zero
}
  802fd8:	03c0e821 	move	sp,s8
  802fdc:	8fbf001c 	lw	ra,28(sp)
  802fe0:	8fbe0018 	lw	s8,24(sp)
  802fe4:	27bd0020 	addiu	sp,sp,32
  802fe8:	03e00008 	jr	ra
  802fec:	00000000 	nop
