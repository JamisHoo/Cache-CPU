...
main:                                   # function entry
          subu $sp, $sp, 4              
  802e80:	27bdfffc afbe0000 afbffffc 03a0f021     ...'........!...
          sw $fp, 0($sp)                
          sw $ra, -4($sp)               
          move $fp, $sp                 
          addiu $sp, $sp, -44           
  802e90:	27bdffd4 afc40004 afc50008 afc6000c     ...'............
          sw $a0, 4($fp)                
          sw $a1, 8($fp)                
          sw $a2, 12($fp)               
          sw $a3, 16($fp)               
...
_L13:                                   
  ...
  802ea8:	25084020 	addiu	t0,t0,16416
          li      $t0, 3                
  802eac:	24080003 	li	t0,3
          li      $t1, 4                
  802eb0:	24090004 	li	t1,4
          li      $t2, 5                
  802eb4:	240a0005 	li	t2,5
          li      $t3, 6                
  802eb8:	240b0006 	li	t3,6
          li      $t4, 7                
  802ebc:	240c0007 	li	t4,7
          move    $a0, $t0              
  802ec0:	01002021 	move	a0,t0
          move    $a1, $t1              
  802ec4:	01202821 	move	a1,t1
          move    $a2, $t2              
  802ec8:	01403021 	move	a2,t2
          move    $a3, $t3              
  802ecc:	01603821 	move	a3,t3
          sw      $t4, 16($sp)          
  802ed0:	afac0010 	sw	t4,16(sp)
          jal     _test                 
  802ed4:	0c200bbe 	jal	802ef8 <_test>
  802ed8:	00000000 	nop
          move    $v0, $zero            
  802edc:	00001021 	move	v0,zero
          move    $sp, $fp              
  802ee0:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  802ee4:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  802ee8:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  802eec:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
  802ef0:	03e00008 	jr	ra
  802ef4:	00000000 	nop
...
_test:                                  # function entry
          subu $sp, $sp, 4              
  802ef8:	27bdfffc 	addiu	sp,sp,-4
          sw $fp, 0($sp)                
  802efc:	afbe0000 	sw	s8,0(sp)
          sw $ra, -4($sp)               
  802f00:	afbffffc 	sw	ra,-4(sp)
          move $fp, $sp                 
  802f04:	03a0f021 	move	s8,sp
          addiu $sp, $sp, -28           
  802f08:	27bdffe4 	addiu	sp,sp,-28
          sw $a0, 4($fp)                
  802f0c:	afc40004 	sw	a0,4(s8)
          sw $a1, 8($fp)                
  802f10:	afc50008 	sw	a1,8(s8)
          sw $a2, 12($fp)               
  802f14:	afc6000c 	sw	a2,12(s8)
          sw $a3, 16($fp)               
  802f18:	afc70010 	sw	a3,16(s8)

00802f1c <_L14>:
_L14:                                   
          la      $t0, _global_addr     
  802f1c:	3c080080 	lui	t0,0x80
  802f20:	25084020 	addiu	t0,t0,16416
          lw      $t0, 4($fp)           
  802f24:	8fc80004 	lw	t0,4(s8)
          move    $a0, $t0              
  802f28:	01002021 	move	a0,t0
          sw      $t0, 4($fp)           
  802f2c:	afc80004 	sw	t0,4(s8)
          jal     _PrintInt             
  802f30:	0c200436 	jal	8010d8 <_PrintInt>
  802f34:	00000000 	nop
          lw      $t0, 4($fp)           
  802f38:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  802f3c:	8fc90008 	lw	t1,8(s8)
          move    $a0, $t1              
  802f40:	01202021 	move	a0,t1
          sw      $t0, 4($fp)           
  802f44:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  802f48:	afc90008 	sw	t1,8(s8)
          jal     _PrintInt             
  802f4c:	0c200436 	jal	8010d8 <_PrintInt>
  802f50:	00000000 	nop
          lw      $t0, 4($fp)           
  802f54:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  802f58:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  802f5c:	8fca000c 	lw	t2,12(s8)
          move    $a0, $t2              
  802f60:	01402021 	move	a0,t2
          sw      $t0, 4($fp)           
  802f64:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  802f68:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  802f6c:	afca000c 	sw	t2,12(s8)
          jal     _PrintInt             
  802f70:	0c200436 	jal	8010d8 <_PrintInt>
  802f74:	00000000 	nop
          lw      $t0, 4($fp)           
  802f78:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  802f7c:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  802f80:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  802f84:	8fcb0010 	lw	t3,16(s8)
          move    $a0, $t3              
  802f88:	01602021 	move	a0,t3
          sw      $t0, 4($fp)           
  802f8c:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  802f90:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  802f94:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  802f98:	afcb0010 	sw	t3,16(s8)
          jal     _PrintInt             
  802f9c:	0c200436 	jal	8010d8 <_PrintInt>
  802fa0:	00000000 	nop
          lw      $t0, 4($fp)           
  802fa4:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  802fa8:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  802fac:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  802fb0:	8fcb0010 	lw	t3,16(s8)
          lw      $t4, 20($fp)          
  802fb4:	8fcc0014 	lw	t4,20(s8)
          move    $a0, $t4              
  802fb8:	01802021 	move	a0,t4
          sw      $t0, 4($fp)           
  802fbc:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  802fc0:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  802fc4:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  802fc8:	afcb0010 	sw	t3,16(s8)
          sw      $t4, 20($fp)          
  802fcc:	afcc0014 	sw	t4,20(s8)
          jal     _PrintInt             
  802fd0:	0c200436 	jal	8010d8 <_PrintInt>
  802fd4:	00000000 	nop
          lw      $t0, 4($fp)           
  802fd8:	8fc80004 	lw	t0,4(s8)
          lw      $t1, 8($fp)           
  802fdc:	8fc90008 	lw	t1,8(s8)
          lw      $t2, 12($fp)          
  802fe0:	8fca000c 	lw	t2,12(s8)
          lw      $t3, 16($fp)          
  802fe4:	8fcb0010 	lw	t3,16(s8)
          lw      $t4, 20($fp)          
  802fe8:	8fcc0014 	lw	t4,20(s8)
          sw      $t0, 4($fp)           
  802fec:	afc80004 	sw	t0,4(s8)
          sw      $t1, 8($fp)           
  802ff0:	afc90008 	sw	t1,8(s8)
          sw      $t2, 12($fp)          
  802ff4:	afca000c 	sw	t2,12(s8)
          sw      $t3, 16($fp)          
  802ff8:	afcb0010 	sw	t3,16(s8)
          sw      $t4, 20($fp)          
  802ffc:	afcc0014 	sw	t4,20(s8)
          move    $v0, $zero            
  803000:	00001021 	move	v0,zero
          move    $sp, $fp              
  803004:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  803008:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  80300c:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  803010:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
  803014:	03e00008 	jr	ra
  803018:	00000000 	nop
  80301c:	00000000 	nop
