...
main(void) {
  ...
  802e94:	244434c0 	addiu	a0,v0,13504
  ...
  802eb0:	14400007 	bnez	v0,802ed0 <main+0x50>
  802eb4:	00000000 	nop
        cprintf("I am the child. spinning ...\n");
  802eb8:	3c020080 	lui	v0,0x80
  802ebc:	244434e8 	addiu	a0,v0,13544
  802ec0:	0c2003a9 	jal	800ea4 <cprintf>
  802ec4:	00000000 	nop
        while (1);
  802ec8:	08200bb2 	j	802ec8 <main+0x48>
  802ecc:	00000000 	nop
    }
    cprintf("I am the parent. Running the child...\n");
  802ed0:	3c020080 	lui	v0,0x80
  802ed4:	24443508 	addiu	a0,v0,13576
  802ed8:	0c2003a9 	jal	800ea4 <cprintf>
  802edc:	00000000 	nop
  ...
  802ef8:	3c020080 	lui	v0,0x80
  802efc:	24443530 	addiu	a0,v0,13616
  802f00:	0c2003a9 	jal	800ea4 <cprintf>
  802f04:	00000000 	nop

    assert((ret = kill(pid)) == 0);
  802f08:	8fc40018 	lw	a0,24(s8)
  802f0c:	0c200218 	jal	800860 <kill>
  802f10:	00000000 	nop
  802f14:	afc2001c 	sw	v0,28(s8)
  802f18:	8fc2001c 	lw	v0,28(s8)
  802f1c:	1040000a 	beqz	v0,802f48 <main+0xc8>
  802f20:	00000000 	nop
  802f24:	3c020080 	lui	v0,0x80
  802f28:	24443558 	addiu	a0,v0,13656
  802f2c:	24050014 	li	a1,20
  802f30:	3c020080 	lui	v0,0x80
  802f34:	24463564 	addiu	a2,v0,13668
  802f38:	3c020080 	lui	v0,0x80
  802f3c:	2447357c 	addiu	a3,v0,13692
  802f40:	0c200008 	jal	800020 <__panic>
  802f44:	00000000 	nop
    cprintf("kill returns %d\n", ret);
  802f48:	3c020080 	lui	v0,0x80
  802f4c:	24443594 	addiu	a0,v0,13716
  802f50:	8fc5001c 	lw	a1,28(s8)
  802f54:	0c2003a9 	jal	800ea4 <cprintf>
  802f58:	00000000 	nop

    assert((ret = waitpid(pid, NULL)) == 0);
  802f5c:	8fc40018 	lw	a0,24(s8)
  802f60:	00002821 	move	a1,zero
  802f64:	0c2001fc 	jal	8007f0 <waitpid>
  802f68:	00000000 	nop
  802f6c:	afc2001c 	sw	v0,28(s8)
  802f70:	8fc2001c 	lw	v0,28(s8)
  802f74:	1040000a 	beqz	v0,802fa0 <main+0x120>
  802f78:	00000000 	nop
  802f7c:	3c020080 	lui	v0,0x80
  802f80:	24443558 	addiu	a0,v0,13656
  802f84:	24050017 	li	a1,23
  802f88:	3c020080 	lui	v0,0x80
  802f8c:	24463564 	addiu	a2,v0,13668
  802f90:	3c020080 	lui	v0,0x80
  802f94:	244735a8 	addiu	a3,v0,13736
  802f98:	0c200008 	jal	800020 <__panic>
  802f9c:	00000000 	nop
    cprintf("wait returns %d\n", ret);
  802fa0:	3c020080 	lui	v0,0x80
  802fa4:	244435c8 	addiu	a0,v0,13768
  802fa8:	8fc5001c 	lw	a1,28(s8)
  802fac:	0c2003a9 	jal	800ea4 <cprintf>
  802fb0:	00000000 	nop

    cprintf("spin may pass.\n");
  802fb4:	3c020080 	lui	v0,0x80
  802fb8:	244435dc 	addiu	a0,v0,13788
  ...
  802fcc:	8fbf0024 	lw	ra,36(sp)
  802fd0:	8fbe0020 	lw	s8,32(sp)
  802fd4:	27bd0028 	addiu	sp,sp,40
