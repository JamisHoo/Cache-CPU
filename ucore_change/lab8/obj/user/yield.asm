...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24442f50 	addiu	a0,v0,12112
  ...
  800078:	24442f6c 	addiu	a0,v0,12140
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24442f70 	addiu	a0,v0,12144
  ...
  8000e8:	24442f6c 	addiu	a0,v0,12140
...
exit(int error_code) {
  ...
  800774:	24442f90 	addiu	a0,v0,12176
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24442fb0 	addiu	a0,v0,12208
  ...
  800d70:	24642fbc 	addiu	a0,v1,12220
  ...
  800d8c:	24642fd0 	addiu	a0,v1,12240
  ...
  800da8:	24642fe4 	addiu	a0,v1,12260
  ...
  800dc4:	24642ff8 	addiu	a0,v1,12280
...
void _PrintInt(int x) {
  ...
  8010f0:	24443010 	addiu	a0,v0,12304
...
void _PrintChar(char x) {
  ...
  801138:	24643014 	addiu	a0,v1,12308
...
void _PrintString(const char* x) {
  ...
  801178:	24443018 	addiu	a0,v0,12312
...
void _PrintBool(bool x) {
  ...
  8011c4:	2444301c 	addiu	a0,v0,12316
  ...
  8011dc:	24443024 	addiu	a0,v0,12324
...
umain(int argc, char *argv[]) {
  ...
  801490:	24453030 	addiu	a1,v0,12336
  ...
  8014b4:	24443038 	addiu	a0,v0,12344
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	2446304c 	addiu	a2,v0,12364
  ...
  8014d8:	24453068 	addiu	a1,v0,12392
  ...
  8014fc:	24443038 	addiu	a0,v0,12344
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463070 	addiu	a2,v0,12400
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	244332a0 	addiu	v1,v0,12960
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	244232cc 	addiu	v0,v0,13004
  ...
  80275c:	2442323c 	addiu	v0,v0,12860
  ...
  802784:	244732b4 	addiu	a3,v0,12980
  ...
  8027ac:	244732c0 	addiu	a3,v0,12992
  ...
  8027dc:	245132c4 	addiu	s1,v0,12996
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  802e90:	0c200226 	jal	800898 <getpid>
  802e94:	00000000 	nop
  802e98:	3c030080 	lui	v1,0x80
  802e9c:	24643430 	addiu	a0,v1,13360
  802ea0:	00402821 	move	a1,v0
  802ea4:	0c2003a9 	jal	800ea4 <cprintf>
  802ea8:	00000000 	nop
    for (i = 0; i < 5; i ++) {
  802eac:	afc00018 	sw	zero,24(s8)
  802eb0:	08200bbb 	j	802eec <main+0x6c>
  802eb4:	00000000 	nop
        yield();
  802eb8:	0c20020c 	jal	800830 <yield>
  802ebc:	00000000 	nop
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  802ec0:	0c200226 	jal	800898 <getpid>
  802ec4:	00000000 	nop
  802ec8:	3c030080 	lui	v1,0x80
  802ecc:	2464344c 	addiu	a0,v1,13388
  802ed0:	00402821 	move	a1,v0
  802ed4:	8fc60018 	lw	a2,24(s8)
...
main(void) {
    ...
    cprintf("Hello, I am process %d.\n", getpid());
    for (i = 0; i < 5; i ++) {
  802ee0:	8fc20018 	lw	v0,24(s8)
  802ee4:	24420001 	addiu	v0,v0,1
  802ee8:	afc20018 	sw	v0,24(s8)
  802eec:	8fc20018 	lw	v0,24(s8)
  802ef0:	28420005 	slti	v0,v0,5
  802ef4:	1440fff0 	bnez	v0,802eb8 <main+0x38>
  802ef8:	00000000 	nop
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
    }
    cprintf("All done in process %d.\n", getpid());
  802efc:	0c200226 	jal	800898 <getpid>
  802f00:	00000000 	nop
  802f04:	3c030080 	lui	v1,0x80
  802f08:	24643470 	addiu	a0,v1,13424
  802f0c:	00402821 	move	a1,v0
  802f10:	0c2003a9 	jal	800ea4 <cprintf>
  802f14:	00000000 	nop
    cprintf("yield pass.\n");
  802f18:	3c020080 	lui	v0,0x80
  802f1c:	2444348c 	addiu	a0,v0,13452
  802f20:	0c2003a9 	jal	800ea4 <cprintf>
  802f24:	00000000 	nop
    return 0;
  802f28:	00001021 	move	v0,zero
}
  802f2c:	03c0e821 	move	sp,s8
  802f30:	8fbf0024 	lw	ra,36(sp)
  802f34:	8fbe0020 	lw	s8,32(sp)
  802f38:	27bd0028 	addiu	sp,sp,40
  802f3c:	03e00008 	jr	ra
  802f40:	00000000 	nop
	...
