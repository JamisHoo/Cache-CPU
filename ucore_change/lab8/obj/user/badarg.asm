...
main(void) {
  ...
  802e8c:	03a0f021 	move	s8,sp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  802e90:	0c2001e2 	jal	800788 <fork>
  802e94:	00000000 	nop
  802e98:	afc2001c 	sw	v0,28(s8)
  802e9c:	8fc2001c 	lw	v0,28(s8)
  802ea0:	14400014 	bnez	v0,802ef4 <main+0x74>
  802ea4:	00000000 	nop
        cprintf("fork ok.\n");
  802ea8:	3c020080 	lui	v0,0x80
  802eac:	24443500 	addiu	a0,v0,13568
  802eb0:	0c2003a9 	jal	800ea4 <cprintf>
  802eb4:	00000000 	nop
        int i;
        for (i = 0; i < 10; i ++) {
  802eb8:	afc00018 	sw	zero,24(s8)
  802ebc:	08200bb6 	j	802ed8 <main+0x58>
  802ec0:	00000000 	nop
            yield();
  802ec4:	0c20020c 	jal	800830 <yield>
  802ec8:	00000000 	nop
main(void) {
    int pid, exit_code;
    if ((pid = fork()) == 0) {
        ...
        int i;
        for (i = 0; i < 10; i ++) {
  802ecc:	8fc20018 	lw	v0,24(s8)
  802ed0:	24420001 	addiu	v0,v0,1
  802ed4:	afc20018 	sw	v0,24(s8)
  802ed8:	8fc20018 	lw	v0,24(s8)
  802edc:	2842000a 	slti	v0,v0,10
  802ee0:	1440fff8 	bnez	v0,802ec4 <main+0x44>
  802ee4:	00000000 	nop
            yield();
        }
        exit(0xbeaf);
  802ee8:	3404beaf 	li	a0,0xbeaf
  802eec:	0c2001d4 	jal	800750 <exit>
  802ef0:	00000000 	nop
    }
    assert(pid > 0);
  802ef4:	8fc2001c 	lw	v0,28(s8)
  802ef8:	1c40000a 	bgtz	v0,802f24 <main+0xa4>
  802efc:	00000000 	nop
  802f00:	3c020080 	lui	v0,0x80
  802f04:	2444350c 	addiu	a0,v0,13580
  802f08:	2405000f 	li	a1,15
  802f0c:	3c020080 	lui	v0,0x80
  802f10:	2446351c 	addiu	a2,v0,13596
  802f14:	3c020080 	lui	v0,0x80
  802f18:	24473534 	addiu	a3,v0,13620
  802f1c:	0c200008 	jal	800020 <__panic>
  802f20:	00000000 	nop
    assert(waitpid(-1, NULL) != 0);
  802f24:	2404ffff 	li	a0,-1
  802f28:	00002821 	move	a1,zero
  802f2c:	0c2001fc 	jal	8007f0 <waitpid>
  802f30:	00000000 	nop
  802f34:	1440000a 	bnez	v0,802f60 <main+0xe0>
  802f38:	00000000 	nop
  802f3c:	3c020080 	lui	v0,0x80
  802f40:	2444350c 	addiu	a0,v0,13580
  802f44:	24050010 	li	a1,16
  802f48:	3c020080 	lui	v0,0x80
  802f4c:	2446351c 	addiu	a2,v0,13596
  802f50:	3c020080 	lui	v0,0x80
  802f54:	2447353c 	addiu	a3,v0,13628
  802f58:	0c200008 	jal	800020 <__panic>
  802f5c:	00000000 	nop
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  802f60:	8fc4001c 	lw	a0,28(s8)
  802f64:	3c05c000 	lui	a1,0xc000
  802f68:	0c2001fc 	jal	8007f0 <waitpid>
  802f6c:	00000000 	nop
  802f70:	1440000a 	bnez	v0,802f9c <main+0x11c>
  802f74:	00000000 	nop
  802f78:	3c020080 	lui	v0,0x80
  802f7c:	2444350c 	addiu	a0,v0,13580
  802f80:	24050011 	li	a1,17
  802f84:	3c020080 	lui	v0,0x80
  802f88:	2446351c 	addiu	a2,v0,13596
  802f8c:	3c020080 	lui	v0,0x80
  802f90:	24473554 	addiu	a3,v0,13652
  802f94:	0c200008 	jal	800020 <__panic>
  802f98:	00000000 	nop
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  802f9c:	27c20020 	addiu	v0,s8,32
  802fa0:	8fc4001c 	lw	a0,28(s8)
  802fa4:	00402821 	move	a1,v0
  802fa8:	0c2001fc 	jal	8007f0 <waitpid>
  802fac:	00000000 	nop
  802fb0:	14400005 	bnez	v0,802fc8 <main+0x148>
  802fb4:	00000000 	nop
  802fb8:	8fc30020 	lw	v1,32(s8)
  802fbc:	3402beaf 	li	v0,0xbeaf
  802fc0:	1062000a 	beq	v1,v0,802fec <main+0x16c>
  802fc4:	00000000 	nop
  802fc8:	3c020080 	lui	v0,0x80
  802fcc:	2444350c 	addiu	a0,v0,13580
  802fd0:	24050012 	li	a1,18
  802fd4:	3c020080 	lui	v0,0x80
  802fd8:	2446351c 	addiu	a2,v0,13596
  802fdc:	3c020080 	lui	v0,0x80
  802fe0:	2447357c 	addiu	a3,v0,13692
  802fe4:	0c200008 	jal	800020 <__panic>
  802fe8:	00000000 	nop
    cprintf("badarg pass.\n");
  802fec:	3c020080 	lui	v0,0x80
  802ff0:	244435b4 	addiu	a0,v0,13748
  802ff4:	0c2003a9 	jal	800ea4 <cprintf>
  802ff8:	00000000 	nop
    return 0;
  802ffc:	00001021 	move	v0,zero
}
  803000:	03c0e821 	move	sp,s8
  803004:	8fbf002c 	lw	ra,44(sp)
  803008:	8fbe0028 	lw	s8,40(sp)
  80300c:	27bd0030 	addiu	sp,sp,48
  803010:	03e00008 	jr	ra
  803014:	00000000 	nop
	...
