...
main:                                   # function entry
  ...
  802e80:	27bdfffc afbe0000 afbffffc 03a0f021     ...'........!...
          ...
          move $fp, $sp                 
          addiu $sp, $sp, -28           
  802e90:	27bdffe4 afc40004 afc50008 afc6000c     ...'............
          sw $a0, 4($fp)                
          sw $a1, 8($fp)                
          sw $a2, 12($fp)               
          sw $a3, 16($fp)               
...
_L12:                                   
  ...
  802ea8:	25084020 	addiu	t0,t0,16416
          la      $t0, _STRING0         
  802eac:	3c080080 	lui	t0,0x80
  802eb0:	25084020 	addiu	t0,t0,16416
          move    $a0, $t0              
  802eb4:	01002021 	move	a0,t0
          jal     _PrintString          
  802eb8:	0c200458 	jal	801160 <_PrintString>
  802ebc:	00000000 	nop
          move    $v0, $zero            
  802ec0:	00001021 	move	v0,zero
          move    $sp, $fp              
  802ec4:	03c0e821 	move	sp,s8
          lw      $ra, -4($fp)          
  802ec8:	8fdffffc 	lw	ra,-4(s8)
          lw      $fp, 0($fp)           
  802ecc:	8fde0000 	lw	s8,0(s8)
          addu    $sp, $sp, 4           
  802ed0:	27bd0004 	addiu	sp,sp,4
          jr      $ra                   
  802ed4:	03e00008 	jr	ra
  802ed8:	00000000 	nop
  802edc:	00000000 	nop
