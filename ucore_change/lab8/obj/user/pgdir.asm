...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24442ee0 	addiu	a0,v0,12000
  ...
  800078:	24442efc 	addiu	a0,v0,12028
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24442f00 	addiu	a0,v0,12032
  ...
  8000e8:	24442efc 	addiu	a0,v0,12028
...
exit(int error_code) {
  ...
  800774:	24442f20 	addiu	a0,v0,12064
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24442f40 	addiu	a0,v0,12096
  ...
  800d70:	24642f4c 	addiu	a0,v1,12108
  ...
  800d8c:	24642f60 	addiu	a0,v1,12128
  ...
  800da8:	24642f74 	addiu	a0,v1,12148
  ...
  800dc4:	24642f88 	addiu	a0,v1,12168
...
void _PrintInt(int x) {
  ...
  8010f0:	24442fa0 	addiu	a0,v0,12192
...
void _PrintChar(char x) {
  ...
  801138:	24642fa4 	addiu	a0,v1,12196
...
void _PrintString(const char* x) {
  ...
  801178:	24442fa8 	addiu	a0,v0,12200
...
void _PrintBool(bool x) {
  ...
  8011c4:	24442fac 	addiu	a0,v0,12204
  ...
  8011dc:	24442fb4 	addiu	a0,v0,12212
...
umain(int argc, char *argv[]) {
  ...
  801490:	24452fc0 	addiu	a1,v0,12224
  ...
  8014b4:	24442fc8 	addiu	a0,v0,12232
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	24462fdc 	addiu	a2,v0,12252
  ...
  8014d8:	24452ff8 	addiu	a1,v0,12280
  ...
  8014fc:	24442fc8 	addiu	a0,v0,12232
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463000 	addiu	a2,v0,12288
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433230 	addiu	v1,v0,12848
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442325c 	addiu	v0,v0,12892
  ...
  80275c:	244231cc 	addiu	v0,v0,12748
  ...
  802784:	24473244 	addiu	a3,v0,12868
  ...
  8027ac:	24473250 	addiu	a3,v0,12880
  ...
  8027dc:	24513254 	addiu	s1,v0,12884
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  802e9c:	246433c0 	addiu	a0,v1,13248
  802ea0:	00402821 	move	a1,v0
  802ea4:	0c2003a9 	jal	800ea4 <cprintf>
  802ea8:	00000000 	nop
    print_pgdir();
  802eac:	0c200232 	jal	8008c8 <print_pgdir>
  802eb0:	00000000 	nop
    cprintf("pgdir pass.\n");
  802eb4:	3c020080 	lui	v0,0x80
  802eb8:	244433d8 	addiu	a0,v0,13272
  802ebc:	0c2003a9 	jal	800ea4 <cprintf>
  802ec0:	00000000 	nop
    return 0;
  802ec4:	00001021 	move	v0,zero
}
  802ec8:	03c0e821 	move	sp,s8
  802ecc:	8fbf001c 	lw	ra,28(sp)
  802ed0:	8fbe0018 	lw	s8,24(sp)
  802ed4:	27bd0020 	addiu	sp,sp,32
  802ed8:	03e00008 	jr	ra
  802edc:	00000000 	nop
