...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80004c:	24442ef0 	addiu	a0,v0,12016
  ...
  800078:	24442f0c 	addiu	a0,v0,12044
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  8000bc:	24442f10 	addiu	a0,v0,12048
  ...
  8000e8:	24442f0c 	addiu	a0,v0,12044
...
exit(int error_code) {
  ...
  800774:	24442f30 	addiu	a0,v0,12080
...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800d4c:	24442f50 	addiu	a0,v0,12112
  ...
  800d70:	24642f5c 	addiu	a0,v1,12124
  ...
  800d8c:	24642f70 	addiu	a0,v1,12144
  ...
  800da8:	24642f84 	addiu	a0,v1,12164
  ...
  800dc4:	24642f98 	addiu	a0,v1,12184
...
void _PrintInt(int x) {
  ...
  8010f0:	24442fb0 	addiu	a0,v0,12208
...
void _PrintChar(char x) {
  ...
  801138:	24642fb4 	addiu	a0,v1,12212
...
void _PrintString(const char* x) {
  ...
  801178:	24442fb8 	addiu	a0,v0,12216
...
void _PrintBool(bool x) {
  ...
  8011c4:	24442fbc 	addiu	a0,v0,12220
  ...
  8011dc:	24442fc4 	addiu	a0,v0,12228
...
umain(int argc, char *argv[]) {
  ...
  801490:	24452fd0 	addiu	a1,v0,12240
  ...
  8014b4:	24442fd8 	addiu	a0,v0,12248
  8014b8:	2405001a 	li	a1,26
  8014bc:	3c020080 	lui	v0,0x80
  8014c0:	24462fec 	addiu	a2,v0,12268
  ...
  8014d8:	24453008 	addiu	a1,v0,12296
  ...
  8014fc:	24442fd8 	addiu	a0,v0,12248
  801500:	2405001d 	li	a1,29
  801504:	3c020080 	lui	v0,0x80
  801508:	24463010 	addiu	a2,v0,12304
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  8022c4:	24433240 	addiu	v1,v0,12864
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  8025d8:	2442326c 	addiu	v0,v0,12908
  ...
  80275c:	244231dc 	addiu	v0,v0,12764
  ...
  802784:	24473254 	addiu	a3,v0,12884
  ...
  8027ac:	24473260 	addiu	a3,v0,12896
  ...
  8027dc:	24513264 	addiu	s1,v0,12900
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  802e94:	244433d0 	addiu	a0,v0,13264
  802e98:	0c2003a9 	jal	800ea4 <cprintf>
  802e9c:	00000000 	nop
    cprintf("I am process %d.\n", getpid());
  802ea0:	0c200226 	jal	800898 <getpid>
  802ea4:	00000000 	nop
  802ea8:	3c030080 	lui	v1,0x80
  802eac:	246433e0 	addiu	a0,v1,13280
  802eb0:	00402821 	move	a1,v0
  802eb4:	0c2003a9 	jal	800ea4 <cprintf>
  802eb8:	00000000 	nop
    cprintf("hello pass.\n");
  802ebc:	3c020080 	lui	v0,0x80
  802ec0:	244433f4 	addiu	a0,v0,13300
  802ec4:	0c2003a9 	jal	800ea4 <cprintf>
  802ec8:	00000000 	nop
    return 0;
  802ecc:	00001021 	move	v0,zero
}
  802ed0:	03c0e821 	move	sp,s8
  802ed4:	8fbf001c 	lw	ra,28(sp)
  802ed8:	8fbe0018 	lw	s8,24(sp)
  802edc:	27bd0020 	addiu	sp,sp,32
