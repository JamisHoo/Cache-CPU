...
\huge 32位MIPS处理器实验测试文档 \\ % The assignment title
...
% why on the earch a new page after each section?
% it's ugly, isn't it?
\input{sections/section1_introduction.tex}
\input{sections/section2_unity_test.tex}
\input{sections/section3_instruction_test.tex}
\input{sections/section4_combination_test.tex}
\input{sections/section5_system_test.tex}
