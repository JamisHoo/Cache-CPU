...
public class Tac {
	public enum Kind {
		...
		ADD, SUB, MUL, MULT, MFLO, DIV, MOD, NEG, LAND, LOR, LNOT, GTR, GEQ, EQU, NEQ, LEQ,
    ...
    /* added by Jamis Hoo */
    public static Tac genMult(Temp src1, Temp src2) {
        return new Tac(Kind.MULT, src1, src2);
    }

    /* added by Jamis Hoo */
    public static Tac genMflo(Temp dst) {
        return new Tac(Kind.MFLO, dst);
    }
